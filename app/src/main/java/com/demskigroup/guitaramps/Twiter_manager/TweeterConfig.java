package com.demskigroup.guitaramps.Twiter_manager;
...
class TweeterConfig
{
    public static String TWITTER_CONSUMER_KEY ="rcemnSzvjvkBmJqwtnHQFlCYC";
    public static String TWITTER_CONSUMER_SECRET ="aaUBAOi5yxj5Fd3KHb13Qa3zvY74ZBY8Ix9eAoLWXzORQDRMim";
    public static String TWITTER_CALLBACK_URL = "https://www.brihaspatitech.com/";
