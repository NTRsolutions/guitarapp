package com.demskigroup.guitaramps.badgeView;
 ...
 * @since 21-Nov-17
 */
class BadgeAnimator extends ValueAnimator {
    private BitmapFragment[][] mFragments;
    private WeakReference<BadgeView> mWeakBadge;

    BadgeAnimator(Bitmap badgeBitmap, PointF center, BadgeView badge) {
    ...
    private class BitmapFragment {
        ...
        void updata(float value, Canvas canvas) {
