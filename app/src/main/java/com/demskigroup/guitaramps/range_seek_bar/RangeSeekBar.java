...
package com.demskigroup.guitaramps.range_seek_bar;
...
public class RangeSeekBar<T extends Number> extends AppCompatImageView
{
     ...
     */
    public static final int ACTIVE_COLOR = Color.parseColor("#5c34a3");
    /**
    ...
    public static Integer DEFAULT_MAXIMUM = 5000;
    public static final int HEIGHT_IN_DP = 5;
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.drawable.like_icon_off;
        int thumbPressed = R.drawable.like_icon_on;
        int thumbDisabled = R.drawable.like_icon_off;
