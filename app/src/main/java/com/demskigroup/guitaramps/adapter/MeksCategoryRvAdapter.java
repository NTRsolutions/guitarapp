 ...
 * @since 2017-05-04
 */
public class MeksCategoryRvAdapter extends RecyclerView.Adapter<MeksCategoryRvAdapter.MyViewHolder>
{
    private List<AllMakes> aL_categoryDatas;
    private Activity mActivity;
    private ClickListener clickListener;
    private static final String TAG=MeksCategoryRvAdapter.class.getSimpleName();
     ...
     */
    public MeksCategoryRvAdapter(Activity mActivity, List<AllMakes> aL_categoryDatas) {
