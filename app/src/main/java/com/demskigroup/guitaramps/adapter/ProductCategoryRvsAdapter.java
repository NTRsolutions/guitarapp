 ...
 * @since 2017-05-04
 */
public class ProductCategoryRvsAdapter extends RecyclerView.Adapter<ProductCategoryRvsAdapter.MyViewHolder>
{
     ...
     */
    public ProductCategoryRvsAdapter(Activity mActivity,ArrayList<ProductCategoryResDatas> aL_categoryDatas) {
