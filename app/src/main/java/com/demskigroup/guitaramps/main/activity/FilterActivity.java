...
import com.demskigroup.guitaramps.adapter.FilterCategoryRvAdapter;
...
import com.demskigroup.guitaramps.utility.GetCompleteAddress;
                ...
                switch (checkedId){
                    case R.id.radio_NewestFirst:
                        ...
                        if(isCheckedWork) {
                            ...
                            FilterActivity.this.radio_NewestFirst.setBackgroundColor(Color.parseColor("#dcdcdc"));
                            FilterActivity.this.radio_ClosestFirst.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_highToLow.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_lowToHigh.setBackgroundColor(Color.parseColor("#ffffff"));
                    ...
                    case R.id.radio_ClosestFirst:
                        if(isCheckedWork) {
                            ...
                            FilterActivity.this.radio_NewestFirst.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_ClosestFirst.setBackgroundColor(Color.parseColor("#dcdcdc"));
                            FilterActivity.this.radio_highToLow.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_lowToHigh.setBackgroundColor(Color.parseColor("#ffffff"));
                    ...
                    case R.id.radio_highToLow:
                        if(isCheckedWork) {
                            ...
                            FilterActivity.this.radio_NewestFirst.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_ClosestFirst.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_highToLow.setBackgroundColor(Color.parseColor("#dcdcdc"));
                            FilterActivity.this.radio_lowToHigh.setBackgroundColor(Color.parseColor("#ffffff"));
                    ...
                    case R.id.radio_lowToHigh:
                        ...
                        if(isCheckedWork) {
                            ...
                            FilterActivity.this.radio_ClosestFirst.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_highToLow.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_lowToHigh.setBackgroundColor(Color.parseColor("#dcdcdc"));
                ...
                switch (checkedId){
                    case R.id.radio_last24hr:
                        ...
                        if(isCheckedWork) {
                            ...
                            FilterActivity.this.radio_last24hr.setBackgroundColor(Color.parseColor("#dcdcdc"));
                            FilterActivity.this.radio_last7day.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_last30day.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_allProduct.setBackgroundColor(Color.parseColor("#ffffff"));
                    ...
                    case R.id.radio_last7day:
                        if(isCheckedWork) {
                            ...
                            FilterActivity.this.radio_last24hr.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_last7day.setBackgroundColor(Color.parseColor("#dcdcdc"));
                            FilterActivity.this.radio_last30day.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_allProduct.setBackgroundColor(Color.parseColor("#ffffff"));
                    ...
                    case R.id.radio_last30day:
                        if(isCheckedWork) {
                            ...
                            FilterActivity.this.radio_last24hr.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_last7day.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_last30day.setBackgroundColor(Color.parseColor("#dcdcdc"));
                            FilterActivity.this.radio_allProduct.setBackgroundColor(Color.parseColor("#ffffff"));
                    ...
                    case R.id.radio_allProduct:
                        if(isCheckedWork) {
                            ...
                            FilterActivity.this.radio_last7day.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_last30day.setBackgroundColor(Color.parseColor("#ffffff"));
                            FilterActivity.this.radio_allProduct.setBackgroundColor(Color.parseColor("#dcdcdc"));
