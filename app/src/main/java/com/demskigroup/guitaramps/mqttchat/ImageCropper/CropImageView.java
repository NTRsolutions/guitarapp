...
public class CropImageView extends FrameLayout {
    ...
    /**
     * receiverImage view widget used to show the image for cropping.
     */
     ...
     * receiverImage to crop must be first set before invoking this, for async - after complete callback.
     *
    ...
    /**
     * Options for scaling the bounds of cropping image to the bounds of Crop receiverImage View.<br>
