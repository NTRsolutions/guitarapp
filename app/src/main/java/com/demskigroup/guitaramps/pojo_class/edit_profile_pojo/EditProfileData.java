package com.demskigroup.guitaramps.pojo_class.edit_profile_pojo;
...
public class EditProfileData
{
    ...
    private String fullName="",profilePicUrl="",username="",websiteUrl="",bio="",email="",phoneNumber="",gender="",businessProfile="",aboutBusiness="",
            mainBannerImageUrl="",thumbnailImageUrl="",place="",latitude="",longitude="",googleVerified="",facebookVerified="",emailVerified="",paypalUrl="";
    ...
    public String getMainBannerImageUrl() {
        return mainBannerImageUrl;
    }

    public void setMainBannerImageUrl(String mainBannerImageUrl) {
