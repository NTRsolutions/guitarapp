package com.yelo.com.mqttchat.Fragments;
/*
...
import com.yelo.com.mqttchat.Activities.MediaHistory;
import com.yelo.com.mqttchat.Activities.MediaHistory_FullScreenVideo;
import com.yelo.com.mqttchat.Adapters.MediaHistory_Adapter;
import com.yelo.com.mqttchat.AppController;
import com.yelo.com.mqttchat.ModelClasses.Media_History_Item;
import com.yelo.com.mqttchat.Utilities.RecyclerItemClickListener;
...
/*
* Fragment containing the list of the media(image or video) sent
*
* */
public class MediaHistory_Sent extends android.support.v4.app.Fragment {
...
//        refine.setVisibility(View.GONE);
        ...
        stickyHeader.setText(R.string.MediaSent);
                            ...
                            try {
                                if (list_visible) {
                                    ...
                                    if (pos == mMessageData.size() - 1) {
                                        ...
                                        try {
                                            stickyHeader.setText(


                                                    Utilities.formatDate(Utilities.tsFromGmt(p.getTS())).substring(9, 24) + " " + getString(R.string.And) + " " + Utilities.formatDate(Utilities.tsFromGmt(mMessageData.get(pos + 1).getTS())).substring(9, 24));
                    ...
                    if (item.getMessageType().equals("2")) {
                        ...
                        if (file.exists()) {
                            ...
                            try {
                                ...
                                getActivity().startActivity(i, ActivityOptionsCompat.makeSceneTransitionAnimation(getActivity()).toBundle());
        ...
        if (mMessageData.size() == 0) {
            ...
            notProducts.setText(R.string.NoMediaSent);
