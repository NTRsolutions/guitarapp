 ...
 * @since 2017-05-04
 */
public class YearCategoryRvAdapter extends RecyclerView.Adapter<YearCategoryRvAdapter.MyViewHolder>
{
    private List<String> aL_categoryDatas;
    private Activity mActivity;
    private ClickListener clickListener;
    private static final String TAG=YearCategoryRvAdapter.class.getSimpleName();
     ...
     */
    public YearCategoryRvAdapter(Activity mActivity, List<String> aL_categoryDatas) {
    ...
    {
        String categoryName=aL_categoryDatas.get(position);
