 ...
 * @since 2017-05-04
 */
public class ModelCategoryRvAdapter extends RecyclerView.Adapter<ModelCategoryRvAdapter.MyViewHolder>
{
    private List<AllModels> aL_categoryDatas;
    private Activity mActivity;
    private ClickListener clickListener;
    private static final String TAG=ModelCategoryRvAdapter.class.getSimpleName();
     ...
     */
    public ModelCategoryRvAdapter(Activity mActivity, List<AllModels> aL_categoryDatas) {
